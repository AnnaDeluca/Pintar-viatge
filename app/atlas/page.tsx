...
export default function GalleryPage() {
  ...
  return (
    <div className="flex flex-col h-dvh overflow-hidden" style={{ background: 'var(--paper)' }}>
      ...
      {/* Header mínim — só el títol i el botó tornar */}
      <header className="flex items-center gap-3 shrink-0 px-4"
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span style={{ fontSize: 11, color: 'var(--ink-35)', fontFamily: 'var(--font-body)', whiteSpace: 'nowrap' }}>
            {totalArt} obres
          </span>
        </div>
      </header>

      {/* Mapa ocupa TOT l'espai restant */}
