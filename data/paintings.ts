...
export const paintings: PaintingMeta[] = [
  ...
  {
    id: 'artemisia',
    title: 'Judith i Holofernes',
    artist: 'Artemisia Gentileschi',
    year: 1614, country: 'Itàlia', flag: '🇮🇹', emoji: '⚔️',
    funFact: 'L\'Artemisia va ser la primera dona admesa a l\'Acadèmia de les Arts del Dibuix de Florència. Valenta i talentosa!',
    palette: ['#E63946','#8B4513','#F5DEB3','#1A1A1A','#654321','#C4A35A','#F4A261','#2364AA'],
    regions: [],
